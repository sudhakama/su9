...
public class suProvisioningConnectorConfig {

    private static final Log log = LogFactory.getLog(suProvisioningConnectorConfig.class);
    private Properties configs;

    public suProvisioningConnectorConfig(Properties configs) {
