...
public class Constants {
    ...
    public static final String DEFAULT_PERMISSION_RESOURCE = "/permission/admin/device-mgt/elevn/user";
    public static final String DEFAULT_ROLE_NAME = "elevn_user";
