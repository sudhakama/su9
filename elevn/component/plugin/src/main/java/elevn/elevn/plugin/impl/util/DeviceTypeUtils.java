...
package elevn.elevn.plugin.impl.util;

import elevn.elevn.plugin.constants.DeviceTypeConstants;
import elevn.elevn.plugin.exception.DeviceMgtPluginException;
import elevn.elevn.plugin.internal.DeviceTypeManagementDataHolder;
...
/**
 * Contains utility methods used by elevn plugin.
 */
public class DeviceTypeUtils {

    private static Log log = LogFactory.getLog(elevn.elevn.plugin.impl.util.DeviceTypeUtils.class);
