...
package elevn.elevn.plugin.internal;

import elevn.elevn.plugin.impl.util.DeviceTypeStartupListener;
import elevn.elevn.plugin.exception.DeviceMgtPluginException;
import elevn.elevn.plugin.impl.util.DeviceTypeUtils;
import elevn.elevn.plugin.impl.DeviceTypeManagerService;
...
/**
 * @scr.component name="elevn.elevn.plugin.internal.ServiceComponent"
 * immediate="true"
