...
package elevn.elevn.plugin.constants;

import org.wso2.carbon.utils.CarbonUtils;
import java.io.File;

public class DeviceTypeConstants {
    public final static String DEVICE_TYPE = "elevn";
    public final static String DEVICE_PLUGIN_DEVICE_NAME = "DEVICE_NAME";
    public final static String DEVICE_PLUGIN_DEVICE_ID = "elevn_DEVICE_ID";
    public final static String STATE_ON = "ON";
    public final static String STATE_OFF = "OFF";

    //sensor events summerized table name
    public static final String SENSOR_EVENT_TABLE = "ORG_WSO2_IOT_DEVICES_elevn";
    public static final String DATA_SOURCE_NAME = "jdbc/elevnDM_DB";
    public final static String DEVICE_TYPE_PROVIDER_DOMAIN = "carbon.super";

    //mqtt tranport related constants
    public static final String MQTT_ADAPTER_NAME = "elevn_mqtt";
    ...
    public static final String SUBSCRIBED_TOPIC = "carbon.super/elevn/+/publisher";
    ...
    public final static String SENSOR_STREAM_DEFINITION = "org.wso2.iot.devices.elevn";
